...
import textStart from '../scss/5-components/main-page.module.scss'


const CVPage = () => {
    return (
        <Layout pageTitle="CV">
            <h3 className={textStart}>Professional Experience</h3>

            <ol className={textStart}>
                <li>
            ...
            <h3 className={textStart}>Voluntary Work</h3>
            <ol className={textStart}>
                <li>
